...
import { amdTempRegisters, typeToLlvm } from './FunctionQuad.js';
...
export class CallQuad extends Quad {
  ...
  public constructor(
    ...
    isExternal: boolean,
    private readonly varDecl: VariableDeclaration | undefined,
    withReturn: boolean
  ) {
    super();
    this.formattedName =
  ...
  public toMips() {
    ...
    return quadsToMips([
      ...
      ...(this.varDecl?.tempVariable === undefined
        ...
        : [
            ...
            new Lw('$v0', this.varDecl.tempVariable.toMipsValue()),
            new Jr('$v0'),
          ]),
      new Addi('$sp', '$sp', stackSize),
  ...
  public toAmd() {
    return quadsToAmd([
      ...
      ...(this.varDecl?.tempVariable === undefined
        ...
        : [
            new NextComment('Calling function by pointer'),
            new MovQ(this.varDecl.tempVariable.toAmdValue(), '%rax'),
            new CallQ('*%rax'),
          ]),
  ...
  public toLlvm(context: LlvmContext) {
    ...
    if (this.varDecl === undefined) {
      ...
      const fn = builder.CreateLoad(
        typeToLlvm(this.varDecl.type, builder, true),
        this.varDecl.llvmValue,
