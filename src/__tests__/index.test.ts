...
test('typeCheckAst', async () =>
  expect(typeCheck(input)).resolves.toEqual([
    ...
    'FATAL [156,3]-[156,20]: Invalid assignment operation',
    'FATAL [158,3]-[158,30]: Invalid assignment operation',
    'FATAL [159,3]-[159,21]: Invalid assignment operation',
    ...
    'FATAL [181,3]-[181,33]: Invalid assignment operation',
    'FATAL [182,3]-[182,34]: Invalid assignment operation',
